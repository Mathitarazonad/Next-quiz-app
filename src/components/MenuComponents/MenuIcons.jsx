...
export default function MenuIcons() {
  ...
  return (
    <div className='flex justify-between w-full'>
      <div className='group relative bg-violet-600 w-[40px] h-[40px] flex items-center justify-center bg-opacity-90 p-1 rounded-full hover:scale-95 duration-300'>
      ...
      <Link href='https://github.com/Mathitarazonad/Next-quiz-app' rel='noopener noreferrer' target='_blank' className='group relative bg-violet-600 w-[40px] h-[40px] flex items-center justify-center bg-opacity-90 p-1 rounded-full hover:scale-95 duration-300'>
